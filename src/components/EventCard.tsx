...
const EventCard = ({ title, start_datetime, end_datetime, location, attendees, category, image }: EventCardProps) => {
      ...
      <CardContent className="p-4">
        ...
        <div className="space-y-2 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="line-clamp-1">Ends: {formatDateTime(end_datetime)}</span>
          </div>
          <div className="flex items-center gap-2">

        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <Button size="lg" variant="outline" className="border-2 bg-white/10 backdrop-blur-sm text-white border-white/30 hover:bg-white/20 transition-all hover:scale-105" onClick={() => window.location.href = '/create'}>
                Create Event
              </Button>
            </div>
          </div>
